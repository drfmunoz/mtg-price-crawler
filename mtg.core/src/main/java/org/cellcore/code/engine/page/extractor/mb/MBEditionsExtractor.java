 ...
 * ==============================================================
 */
public class MBEditionsExtractor extends AbstractEditionsExtractor {
    public MBEditionsExtractor(Map<String, String> editions) {
        super(editions);
    }

    @Override
    public String getCrawlerClass() {
        return MBEditionCrawler.class.getCanonicalName();
    }

    @Override
    public String getExtractorClass() {
        return MBPageDataExtractor.class.getCanonicalName();
    }

    @Override
    public String getBaseUrl() {
        return "http://www.magicbazar.fr";
    }

    @Override
    public Map<String, String> getCardSets(Document doc) {
        Elements elements = doc.select("#my_body").get(0).children().get(3).select("a");
