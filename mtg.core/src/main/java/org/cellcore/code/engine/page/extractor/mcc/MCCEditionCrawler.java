 ...
 * ==============================================================
 */
public class MCCEditionCrawler extends AbstractEditionLocationCrawler {


    public MCCEditionCrawler(String url) {
        super(url);
    }

    @Override
    protected List<String> extract(Document doc) {
        Elements cards = doc.select("#content").get(0).getElementsByAttributeValueContaining("href", "carte-magic");
