 ...
 * ==============================================================
 */
public class STCEditionsExtractor extends AbstractEditionsExtractor {
    public STCEditionsExtractor(Map<String, String> editions) {
        super(editions);
    }

    @Override
    public String getCrawlerClass() {
        return STCEditionCrawler.class.getCanonicalName();
    }

    @Override
    public String getExtractorClass() {
        return STCPageDataExtractor.class.getCanonicalName();
    }

    @Override
    public String getBaseUrl() {
        return "http://sales.starcitygames.com";
    }

    @Override
    public Map<String, String> getCardSets(Document doc) {
        Elements elements = doc.select(".cardset_lists").select("a");
